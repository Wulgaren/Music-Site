        ...
        $(this).click(function () {
            ...
            switch ($(this).attr('id')) {
                ...
                case "popModal":
                    ...
                    break
                case "rapModal":
                    htmlToAppend = `Rap na przestrzeni lat bardzo się zmienił, <span class="underline" onclick="playAudio('./assets/hiphopoldschool.mp3')">począwszy od gangsterskich beatów z USA</span> aż do <span class="underline" onclick="playAudio('./assets/hiphoptrap.mp3')">trapu</span>. Powszechne stało się również programu Autotune, który służy do przetworzeniu głosu, tak aby był jak najbardziej w tonacji, dając mu specyficzny dźwięk.`
                    break
                case "phonkModal":
                    htmlToAppend = `Najbardziej rozpoznawalnymi samplami (czyli fragmentu wcześniej dokonanego nagrania muzycznego) to 
                        <span class="underline" onclick="playAudio('./assets/Cowbell808.aif')">cowbell</span> i wokale rapowane wzięte z utworów podgatunku hip-hopowego 
                        <span class="underline" onclick="playAudio('./assets/MemphisRap.aif')">"Memphis Rap".</span>`
                    break
                case "houseModal":
                    htmlToAppend = `House jest znany z <span class="underline" onclick="playAudio('./assets/housebeat.aif')">perkusji</span> gdzie stopka (basowa część perkusji) uderza na każdą nutę jak i z <span class="underline" onclick="playAudio('./assets/housepiano.aif')">skocznego pianina</span>.`
                    break
                case "jazzModal":
